package com.example.fblab.adapter
...
class TaskAdapter(context: Context, toDoItemList: MutableList<Task>) : BaseAdapter() {
    private val mInflater: LayoutInflater = LayoutInflater.from(context)
    private var itemList = toDoItemList
    private var rowListener: TaskListener = context as TaskListener
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.ibDeleteObject.setOnClickListener {
            rowListener.onTaskDelete(objectId)
        }
        return view
    }
